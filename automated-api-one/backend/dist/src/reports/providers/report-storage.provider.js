...
exports.LocalStorageProvider = exports.REPORT_STORAGE_PROVIDER = void 0;
const common_1 = require("@nestjs/common");
const fs = __importStar(require("fs/promises"));
const path = __importStar(require("path"));
exports.REPORT_STORAGE_PROVIDER = 'ReportStorageProvider';
let LocalStorageProvider = class LocalStorageProvider {
    uploadDir = path.join(process.cwd(), 'uploads', 'reports');
...
//# sourceMappingURL=report-storage.provider.js.map