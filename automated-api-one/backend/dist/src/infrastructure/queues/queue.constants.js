...
exports.getSnapshotQueueName = getSnapshotQueueName;
exports.getSnapshotDlqName = getSnapshotDlqName;
exports.Queues = {
    SIGNAL_PROCESSING: 'trade-execution',
...
function getSnapshotQueueName(userId) {
    let hash = 0;
...
function getSnapshotDlqName(userId) {
    let hash = 0;
    for (let i = 0; i < userId.length; i++) {
        hash += userId.charCodeAt(i);
    }
