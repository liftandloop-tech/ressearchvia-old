...
const adminAuditLogSchema = new mongoose.Schema({
    ...
    action: {
        type: String,
        required: true,
        enum: ["USER_CREATE", "USER_UPDATE", "PAYMENT_BYPASS", "SUBSCRIPTION_EXTEND", "SUBSCRIPTION_REVOKE", "SUBSCRIPTION_CHANGE", "KYC_UPDATE", "LOGIN", "REPORT_PUBLISH", "SUBSCRIPTION_SUSPEND", "SUBSCRIPTION_ACTIVATE", "SUBSCRIPTION_UPDATE_DATES", "ADMIN_CREATE_PLAN", "ADMIN_CREATE_PLAN_PARTIAL", "PAYMENT_PRE_APPROVAL_EDIT", "HIGH_SENSITIVITY_CORRECTION", "PAYMENT_LEDGER_CORRECTION", "PAYMENT_APPROVAL_REVERTED", "PAYMENT_REJECTION_REVERTED", "USER_REFUND_PROCESSED", "ADMIN_ALLOCATE_SEGMENTS"]
    },
    targetUserId: {
        type: mongoose.Schema.Types.ObjectId,
        ref: "users",
